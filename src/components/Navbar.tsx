...
import { LogOut, User, LayoutDashboard, Shield } from 'lucide-react'; // Added Icons
            ...
            {user ? (
              ...
              <div className="relative">
                <button onClick={() => setIsProfileOpen(!isProfileOpen)} className="flex items-center gap-3 focus:outline-none">
                  ...
                  <div className="w-10 h-10 rounded-full border-2 border-[#D4AF37] overflow-hidden bg-gray-800 relative shadow-lg">
